...
/**
 * Created by Caleb Stevenson on 1/21/2017.
 * Assets.java
 * <p>
 * Contains any references for assets [sound, images, animations, music] for a simplified access point.
 * Also ensures assets are loaded during the Loading Screen.
 */
...
public class Assets {
    ...
    public static AssetManager load() {
        ...
        */
        ...
        //TODO: am.load(SPRITES_ATLAS, TEXTURE_ATLAS);
    ...
    private static void loadSplash() {
        splashScreen = new TextureRegion(new Texture("cardgame-bg-2.png"));//"ld37-bg.png"));
    ...
    /**
     * Retrieves the requested BitmapFont by fontname from the AssetManager
     *
