...
public class CardGameDBTest extends Game {
   ...
   // public static ScreenDispatcherWarmup screenDispatcher;
    ...
    public CardGameDBTest(TestDatabase db, ActionResolver resolver) {
        this.db = db;
    ...
    public void create() {
        ...
        Screen gameScreen = new GameScreen(batch, screenDispatcher, this, db, resolver);
