...
import com.exovum.tools.components.BookComponent.BookTitle;
import com.exovum.tools.components.AnimationComponent;
import com.exovum.tools.components.BodyComponent;
import com.exovum.tools.components.BookComponent;
import com.exovum.tools.components.BoundsComponent;
import com.exovum.tools.components.ChildComponent;
import com.exovum.tools.components.FontComponent;
...
import com.exovum.tools.systems.RenderingSystem;
...
public class SchoolWorld {
    ...
    private void createBook(int bookid, float fromX, float fromY, float toX, float toY) {
        ...
        BookTitle title = BookComponent.BookTitle.getBookTitleByID(bookid);
        book.title = title;
